...
class GHProjectEntity: ProjectEntity {
    ...
    enum CodingKeys: String, CodingKey {
        case id             = "id"
        case owner_url      = "owner_url"
        case url            = "url"
        case html_url       = "html_url"
        case columns_url    = "columns_url"
    ...
    required init(from decoder: Decoder) throws {
        ...
        do      { self.ownerURL   = try container.decode(String.self  , forKey: .owner_url) }
        catch   { self.ownerURL   = "" }
        ...
        do      { self.columnsURL   = try container.decode(String.self  , forKey: .columns_url) }
        catch   { self.columnsURL   = "" }
        ...
        do      { self.state   = try container.decode(String.self  , forKey: .state) }
        catch   { self.state   = "" }
