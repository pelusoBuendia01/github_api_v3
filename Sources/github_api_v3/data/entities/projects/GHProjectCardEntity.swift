...
class GHProjectCardEntity : ProjectCardEntity {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case column_url     = "column_url"
        case content_url    = "content_url"
        case project_url    = "project_url"
    }
    ...
    required init(from decoder: Decoder) throws {
        ...
        catch   { self.nodeId = GHProjectCardEntity.NO_NODE_ID }
        
        do      { self.note = try container.decode(String.self, forKey: .note) } 
        catch   { self.note = GHProjectCardEntity.NO_NOTE }
        
        do      { self.creator = try container.decode(GHUserEntity.self, forKey: .creator) } 
        catch   { self.creator = nil }
        ...
        catch   { self.archived = false }
        
        do      { self.columnURL = try container.decode(String.self, forKey: .column_url) } 
        catch   { self.columnURL = GHProjectCardEntity.NO_COLUMN_URL }
        
        do      { self.contentURL = try container.decode(String.self, forKey: .content_url) } 
        catch   { self.contentURL = GHProjectCardEntity.NO_CONTENT_URL }
        
        do      { self.projectURL = try container.decode(String.self, forKey: .project_url) } 
        catch   { self.projectURL = GHProjectCardEntity.NO_PROJECT_URL }
